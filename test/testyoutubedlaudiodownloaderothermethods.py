...
class TestYoutubeDlAudioDownloaderOtherMethods(unittest.TestCase):
	...
	def testGetPlaylistObjectAndTitleFortUrl(self):
	...
	def testGetPlaylistObjectAndTitleFortUrlInvalidURL_GeeksForGeeks(self):
		...
		youtubePlaylist, playlistTitle, videoTitle, accessError = youtubeAccess.getPlaylistObjectAndTitleFortUrl(
			playlistUrl)
	...
	def testGetPlaylistObjectAndTitleFortUrl_one_time_frame_extract(self):
		guiOutput = GuiOutputStub()
		youtubeAccess = YoutubeDlAudioDownloader(guiOutput, DirUtil.getTestAudioRootPath())
	...
	def testGetPlaylistObjectAndTitleFortUrl_one_time_frame_suppress(self):
		guiOutput = GuiOutputStub()
		youtubeAccess = YoutubeDlAudioDownloader(guiOutput, DirUtil.getTestAudioRootPath())
	...
	def testGetPlaylistObjectAndTitleFortUrl_one_time_frame_extract_suppress(self):
		guiOutput = GuiOutputStub()
		youtubeAccess = YoutubeDlAudioDownloader(guiOutput, DirUtil.getTestAudioRootPath())
	...
	def testGetPlaylistObjectAndTitleFortUrl_one_time_frame_suppress_extract(self):
		guiOutput = GuiOutputStub()
		youtubeAccess = YoutubeDlAudioDownloader(guiOutput, DirUtil.getTestAudioRootPath())
	...
	def testGetPlaylistObjectAndTitleFortUrl_multiple_time_frame_extract_suppress(self):
		guiOutput = GuiOutputStub()
		youtubeAccess = YoutubeDlAudioDownloader(guiOutput, DirUtil.getTestAudioRootPath())
