...
class TestYoutubeDlAudioDownloaderDownloadMethods_1(unittest.TestCase):
	def testDownloadPlaylistVideosForUrlMultipleVideo(self):
		...
		self.assertEqual('https://www.youtube.com/watch?v=9iPvLx7gotk', downloadVideoInfoDic.getVideoUrlForVideoTitle(
		...
		self.assertEqual('Here to help - Give him what he wants.mp3',
		                 downloadVideoInfoDic.getVideoFileNameForVideoTitle('Here to help: Give him what he wants'))
