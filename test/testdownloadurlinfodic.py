...
class TestDownloadUrlInfoDic(unittest.TestCase):
 ...
 ''], outputCapturingString.getvalue().split('\n'))
	...
	def testAddUrlDownloadData_new_info_dic_file(self):
		audioDirRoot = DirUtil.getTestAudioRootPath()
		downloadDir = audioDirRoot + sep + 'tst_url_info_dic_1'
		urlDicFileName = 'urlListDic'
		...
		urlTitle_1 = 'test warning index date files_noIndexNoDate'
		url_1 = 'https://youtube.com/playlist?list=PLzwWSJNcZTMRVKblKqskAyseCgsUmhlSc'
		uld = UrlDownloadData(type=DownloadUrlInfoDic.URL_TYPE_PLAYLIST,
		                      title=urlTitle_1,
		                      url=url_1)
		dui.addUrlDownloadData(uld)

		urlTitle_2 = 'Here to help: Give him what he wants'
		url_2 = 'https://www.youtube.com/watch?v=Eqy6M6qLWGw'
		uld = UrlDownloadData(type=DownloadUrlInfoDic.URL_TYPE_SINGLE_VIDEO,
		                      title=urlTitle_2,
		                      url=url_2)
		dui.addUrlDownloadData(uld)
		...
		self.assertEqual([1, 2], dui.getSortedUrlIndexLst())
 ...
 ''], outputCapturingString.getvalue().split('\n'))
		...
		dicFilePathNameLst = DirUtil.getFilePathNamesInDirForPattern(downloadDir,
		                                                             '*' + DownloadUrlInfoDic.DIC_FILE_NAME_EXTENT)
		dui_reloaded = DownloadUrlInfoDic(existingDicFilePathName=dicFilePathNameLst[0])
		...
		self.assertEqual([1, 2], dui_reloaded.getSortedUrlIndexLst())
		...
		self.assertEqual(3, dui_reloaded.getNextUrlIndex())
