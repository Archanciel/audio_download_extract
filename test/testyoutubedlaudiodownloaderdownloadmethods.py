...
class TestYoutubeDlAudioDownloaderDownloadMethods(unittest.TestCase):
 ...
 ''], outputCapturingString.getvalue().split('\n'))
	...
	def testDownloadVideosReferencedInPlaylistForPlaylistUrlMultipleVideo_redownloading_the_playlist(self):
		...
		redownloadVideoInfoDic, accessError = youtubeAccess_redownload.getDownloadVideoInfoDicForPlaylistTitle(
			playlistTitle)
...
#	unittest.main()
	...
	tst.testDownloadVideosReferencedInPlaylistForPlaylistUrl_empty_url()
