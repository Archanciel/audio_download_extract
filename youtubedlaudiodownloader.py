		...
		with youtube_dl.YoutubeDL(self.ydl_opts) as ydl:
			for videoUrl in playlistObject.video_urls:
				...
				try:
					...
					self.audioController.displayError("downloading video [b]{}[/b] caused this Attribute exception: {}. [color=HH0000]WARNING[/color]: bookmarks will be ignored !\n".format(videoTitle, e))
					self.displayRetryPlaylistDownloadMsg(downloadVideoInfoDic)
	...
	def downloadSingleVideoForUrl(self,
		...
		with youtube_dl.YoutubeDL(self.ydl_opts) as ydl:
			...
			try:
				...
				msgText = "downloading video [b]{}[/b] caused this Attribute exception: {}. [color=HH0000]WARNING[/color]: bookmarks will be ignored !\n".format(
		...
		with youtube_dl.YoutubeDL(self.ydl_opts) as ydl:
			...
			try:
				...
				self.audioController.displayError(
					"downloading video [b]{}[/b] caused this Attribute exception: {}. [color=HH0000]WARNING[/color]: bookmarks will be ignored !\n".format(
