...
class ConfigManager:
	...
	DEFAULT_DATA_PATH_IOS = DirUtil.getDefaultAudioRootPath()
	...
	DEFAULT_SINGLE_VIDEO_DATA_PATH_IOS = DirUtil.getDefaultAudioRootPath()
	...
	DEFAULT_CONFIG_KEY_DROP_DOWN_MENU_WIDTH_IOS = '25'
